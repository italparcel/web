...
const UPDATED: L = {
  en: "Last update: 2 July 2026 · Version 1.3 · English version",
  it: "Ultimo aggiornamento: 2 luglio 2026 · Versione 1.3 · Versione italiana",
};
  ...
  },
  {
    ...
    paras: [
      ...
      },
      {
        ...
        it: "**(a)** Cookie tecnici (cookie di sessione, di navigazione e di sicurezza/prestazione), strettamente necessari al corretto funzionamento e alla sicurezza del sito. Tra questi rientrano cookie tecnici di terze parti impostati da Cloudflare (ad es. “__cf_bm”) in relazione alla protezione anti-bot/CAPTCHA del modulo di contatto. Tali cookie rientrano nell'esenzione prevista dall'articolo 122, comma 1, del Codice Privacy e non richiedono il consenso dell'utente; **(b)** Cookie pubblicitari, impostati da Google Ads (ad es. “_gcl_au” e cookie dei domini google.com / doubleclick.net), utilizzati per misurare le conversioni generate dalle campagne pubblicitarie del Titolare. Tali cookie non sono necessari al funzionamento del sito. Per gli utenti situati nello Spazio Economico Europeo, nel Regno Unito e in Svizzera, essi sono attivati solo dopo che l'utente ha prestato il consenso tramite il banner dei cookie visualizzato al primo accesso al sito; al di fuori di tali aree sono attivi per impostazione predefinita (impostazioni regionali della Google Consent Mode) e possono essere rifiutati o disattivati in qualsiasi momento tramite il banner / le impostazioni dei cookie.",
      },
      {
